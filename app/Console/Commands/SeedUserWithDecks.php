    ...
    public function handle()
    {
        ...
        $cardData = [
            [
                ...
                'imgUris' => [
                    'art_crop' =>
                        'https://cards.scryfall.io/art_crop/front/4/f/4f616706-ec97-4923-bb1e-11a69fbaa1f8.jpg?1726837907',
                    'border_crop' =>
                        'https://cards.scryfall.io/border_crop/front/4/f/4f616706-ec97-4923-bb1e-11a69fbaa1f8.jpg?1726837907',
                    'large' =>
                        'https://cards.scryfall.io/large/front/4/f/4f616706-ec97-4923-bb1e-11a69fbaa1f8.jpg?1726837907',
                    'normal' =>
                        'https://cards.scryfall.io/normal/front/4/f/4f616706-ec97-4923-bb1e-11a69fbaa1f8.jpg?1726837907',
                    'png' =>
                        'https://cards.scryfall.io/png/front/4/f/4f616706-ec97-4923-bb1e-11a69fbaa1f8.png?1726837907',
                    'small' =>
                        'https://cards.scryfall.io/small/front/4/f/4f616706-ec97-4923-bb1e-11a69fbaa1f8.jpg?1726837907',
                ],
                'manaCost' => ['{U}', '{U}'],
            ],
        ];
        ...
        $this->info(
            "Successfully created {$count} decks for user ID {$userId}."
        );
        return 0;
    }
}
