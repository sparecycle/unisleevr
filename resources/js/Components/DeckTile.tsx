...
const DeckTile = forwardRef<HTMLDivElement, DeckTileProps>(
    ({ title, deck, activeSetter, onDelete, isButton, buttonAction }, ref) => {
        return (
            <div
                ref={ref}
                className="group/deck-tile btn bg-lg relative flex aspect-[2.5/3] flex-col rounded-md border border-solid border-zinc-600 bg-zinc-200 hover:bg-zinc-300 focus:bg-zinc-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 active:bg-zinc-400 dark:bg-zinc-950 dark:hover:bg-zinc-900 dark:focus:bg-zinc-900 dark:active:bg-zinc-800"
            >
                {isButton && (
